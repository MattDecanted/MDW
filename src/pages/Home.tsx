  ...
  const testimonials = [
    {
      ...
      quote: t('home.testimonials.sarah.quote', "Matt's approach transformed how I understand wine. The blind tastings are addictive!"),
    ...
    },
    {
      ...
      quote: t('home.testimonials.james.quote', "Weekly wine shorts are perfect for my schedule. Learning so much in just 10 minutes!"),
    ...
    },
    {
      ...
      quote: t('home.testimonials.emma.quote', "Started with the free guide and now I'm hooked. The community is so welcoming!"),
  ...
  const features = [
    {
      ...
      description: t('home.features.shorts.description', 'Bite-sized wine education videos perfect for busy schedules'),
    ...
    },
    {
      ...
      description: t('home.features.swirdle.description', 'Daily wine word game that builds your vocabulary'),
    ...
    },
    {
      ...
      description: t('home.features.blindTasting.description', 'Test your palate with weekly blind tasting sessions'),
    ...
    },
    {
      ...
      description: t('home.features.community.description', 'Connect with fellow wine enthusiasts worldwide'),
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                {t('home.hero.headline', 'Learn wine from the winemaker behind 10 years of Wine Spectator Top 100')}
              </h1>
              
              <p className="text-xl text-gray-700 mb-8 max-w-2xl">
                {t('home.hero.subheadline', 'Taste, talk, and think like a winemaker — without the pretension.')}
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="group relative bg-white border border-gray-200 rounded-xl p-6 hover:shadow-xl hover:border-blue-300 transition-all duration-300 transform hover:-translate-y-1">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                {t('home.credibility.recognitionDesc', '10 years in a row')}
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              {t('home.community.description', 'Not stuffy. Not snobby. Just brilliant wine, great stories, and a winemaker who wants to take you along for the ride.')}
            </p>
          </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="flex items-center">
                      ...
                      {testimonial.tier === 'premium' && <Crown className="w-4 h-4 text-purple-600 ml-2" />}
                      {testimonial.tier === 'basic' && <Star className="w-4 h-4 text-amber-600 ml-2" />}
                    </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              ...
              <p className="text-xl text-purple-100 mb-6">
                {t('home.swirdle.description', 'Challenge your wine vocabulary with our daily word puzzle. Guess the wine term in 6 tries!')}
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-amber-100 mb-8">
              {t('home.finalCta.subtitle', 'Join thousands of wine lovers who have discovered the joy of authentic wine education')}
            </p>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-blue-100 text-sm">
                    {t('home.stickyCtaSubtitle', 'Join 2,500+ students learning authentic wine education')}
                  </p>
                </div>
              </div>
